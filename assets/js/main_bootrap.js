...
function sidebarType(button) {
  ...
  // Change the sidebar type based on the data-class attribute
  const sidebarClass = button.getAttribute('data-class');
  // Assuming you have a function to change the sidebar class
  changeSidebarClass(sidebarClass);
}

function changeSidebarClass(className) {
  // Logic to change the sidebar class
  const sidebar = document.querySelector('.sidebar'); // Adjust selector as needed
  sidebar.className = className; // Update the sidebar class
}
