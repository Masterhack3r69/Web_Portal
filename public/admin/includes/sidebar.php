...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-white" id="sidenav-main" >
    <div class="sidenav-header">
      <a class="navbar-brand text-center m-0 fs-6" href="#">
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav pb-5">
        ...
        <?php if ($_SESSION['admin_type'] === 'central'): ?>
          ...
          <li class="nav-item">
            <a class="nav-link <?= $pageHover == 'form.php' ? 'active' : ''; ?>" href="../central_admin/form.php">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../pages/tables.html">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i class="fa fa-globe text-dark text-sm"></i>
              </div>
          ...
          <li class="nav-item">
            <a class="nav-link" href="../pages/tables.html">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i class="fa fa-user text-dark text-sm"></i>
              </div>
        ...
        <?php elseif ($_SESSION['admin_type'] === 'local'): ?>
          ...
          <li class="nav-item">
            <a class="nav-link <?= $pageHover == 'user.php' ? 'active' : ''; ?>" href="../local_admin/user.php">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i class="fa fa-users <?= $pageHover == 'user.php' ? 'text-white' : 'text-dark'; ?> text-sm"></i>
              </div>
              <span class="nav-link-text ms-1">Users</span>
